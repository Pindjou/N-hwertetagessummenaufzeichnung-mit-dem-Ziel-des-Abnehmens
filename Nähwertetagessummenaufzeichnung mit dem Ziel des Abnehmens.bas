...
Hallo = MsgBox("Diese Aufzeichnung hat das Ziel des Abnehmens", vbExclamation, "Meldung - byRichards Kalorientabelle für Chihauhas und andere Kleinhunde")
...
Hallo = MsgBox("Sie haben Ihr Ziel erreicht", vbInformation, "Gluckwunsch - byRichards Kalorientabelle für Chihauhas und andere Kleinhunde")
...
'Worksheets("Tagessummen").Select   ????? um zu sehen dass er Wirklich übernommen hat
...
'Hallo = MsgBox("Nur x Tage zum Ziel", VbInformation, "Meldung - byRichards Kalorientabelle für Chihauhas und andere Kleinhunde")
